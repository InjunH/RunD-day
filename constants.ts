...
export const MARATHON_DATA: MarathonEvent[] = [
  ...
  { id: '3', name: '제2회 한강 서울 하프 마라톤', date: '2026-01-25', region: '서울', locationDetail: '상암 월드컵공원', distances: ['하프', '10km', '5km'], registrationUrl: 'http://gorunning.kr', tags: ['인기대회', '한강'], isPopular: true },
  { id: '4', name: '화성 궁평항 동계 훈련 마라톤', date: '2026-01-31', region: '경기', locationDetail: '화성시 궁평항', distances: ['32km', '하프', '10km'], registrationUrl: '', tags: ['동계훈련'] },
